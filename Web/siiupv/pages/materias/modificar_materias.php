            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?id={$dato}" ?>" role="form">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre" placeholder="Ingrese una descripcion" value="<?php echo utf8_encode($valor["nombre"])?>" required>
                </div>
                <div class="form-group">
                  <label for="">Nombre Corto</label>
                  <input type="text" class="form-control" name="nombre_corto" placeholder="Ingrese una descripcion" value="<?php echo utf8_encode($valor["nombre_corto"])?>" required>
                </div>
              </div>
              <!-- /.box-body -->
                <?php } ?>
