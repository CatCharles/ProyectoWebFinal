                ...
                <tbody>
                  ...
                  //Aqui res son los valores que extrae y el valor es mostrar los valores
                    foreach ($res as $valor) {
                      ...
                      echo "<td class=\"sorting_2\">".utf8_encode($valor["id"])."</td>";
                      echo "<td>".utf8_encode($valor["nombre"])."</td>";
                      echo "<td>".utf8_encode($valor["nombre_corto"])."</td>";
                      //Impoirtante aqui se usa el metodo get para mandarle el valor por parametro
                      echo "<td>
                      <div class=\"btn-group\">
                        <a  href=\"modificar_materias.php?id=".utf8_encode($valor["id"])."\" type=\"button\" class=\"btn btn-info\"><i class=\"fa fa-fw fa-pencil\"></i></a>
                        <a  href=\"borrar_materias.php?id=".utf8_encode($valor["id"])."\" type=\"button\" class=\"btn btn-danger\"><i class=\"fa fa-fw fa-trash\"></i></a>
                      </div>
                    </td>";
                      echo "</tr>";
