                ...
                <tbody>
                  ...
                  //Aqui res son los rowes que extrae y el row es mostrar los rowes
                    while($row=$resultado->fetch_assoc()) {
                      ...
                      echo "<td class=\"sorting_2\">".utf8_encode($row["id"])."</td>";
                      echo "<td>".utf8_encode($row["matricula"])."</td>";
                      echo "<td>".utf8_encode($row["nombre"])."</td>";
                      echo "<td>".utf8_encode($row["paterno"])."</td>";
                      echo "<td>".utf8_encode($row["materno"])."</td>";
                      echo "<td>".utf8_encode($row["carrera"])."</td>";
                      echo "<td>".utf8_encode($row["escuela_procedencia"])."</td>";
                      echo "<td>".utf8_encode($row["promedio_ingreso"])."</td>";
                      echo "<td>".utf8_encode($row["puntos_ceneval"])."</td>";
                      ...
                      <div class=\"btn-group\">
                        ...
                        <a  href=\"borrar.php?id=".$row["id_persona"]."\" type=\"button\" class=\"btn btn-danger\"><i class=\"fa fa-fw fa-trash\"></i></a>
                      </div>
                    </td>";
                      echo "</tr>";
