<?php
  ...
  function valida_usuario_bd($conexion,$usuario,$contrasena){
    $query = "SELECT id_persona, nombre, paterno, tipo FROM usuarios INNER JOIN personas ON usuarios.id_persona = personas.id WHERE `username` = '$usuario' AND `password` = MD5('$contrasena');";
