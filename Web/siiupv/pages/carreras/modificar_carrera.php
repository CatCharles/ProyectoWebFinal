            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?id={$dato}" ?>" role="form">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre" placeholder="Ingrese la carrera" value="<?php echo utf8_encode($carre["nombre"])?>" required>
                </div>
                <div class="form-group">
                  <label for="siglas">Siglas</label>
                  <input type="text" class="form-control" name="siglas" placeholder="Ingrese las siglas" value="<?php echo utf8_encode($carre["siglas"])?>" required>
                </div>
              </div>
              <!-- /.box-body -->
                <?php } ?>
