...
if($_SESSION['tipo']!=2){
  ...
  $query = 'select class.id, 
              ...
              UPPER(CONCAT(per.nombre," ",per.paterno," ",per.materno)) as nombre_maestro
              from clases class
                    inner join grupos g on class.id_grupo = g.id
                    inner join carreras carr on g.id_carrera = carr.id
                    inner join planes_estudio pl on g.id_plan = pl.id
                    inner join materias ma on class.id_materia = ma.id
                    inner join maestros mast on mast.id = class.id_maestro
                    inner join personas per on per.id = mast.id_persona';                  
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="">Materia
                   ...
                   <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="">Maestro
                  </th>
                </tr>
                </thead>
                <tbody>
                ...
                <?php
                  foreach ($res as $clases) {
                    ...
                    echo "<td>".utf8_encode($clases["nombre_materia"])."</td>";
                    
                    echo "<td>".utf8_encode($clases["nombre_maestro"])."</td>";
